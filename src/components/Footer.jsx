        ...
        <div className="maps md:mt-0 mt-4">
          <div class="mapouter">
            <div class="gmap_canvas">
              <iframe width="230" height="200" id="gmap_canvas" src="https://maps.google.com/maps?q=smkn%201%20cibinong&t=&z=17&ie=UTF8&iwloc=&output=embed" frameborder="0" scrolling="no" marginheight="0" marginwidth="0"></iframe>
            </div>
          </div>
        </div>
      </div>
