    ...
    <div id="home">
      ...
      >
        <div className="text-center">
          <h1 className="text-2xl lg:text-5xl sm:text-3xl md:text-4xl font-bold uppercase">majority</h1>
      ...
      >
        <div className="text-center">
          <h1 className="text-2xl lg:text-5xl sm:text-3xl md:text-4xl font-bold uppercase">news update</h1>
          <p className="text-xl text-home-text-p">
            About nevtiks activities and achievements :
          </p>
        </div>
      ...
      >
        <div className="text-center">
          <h1 className="lg:text-5xl sm:text-3xl md:text-4xl font-bold uppercase text-2xl">extracurricular</h1>
        ...
        <a href="/extracurricular" class="btn-hover-white text-main-color border-2 border-main-color hover:bg-main-color hover:text-light-one text-xl font-bold py-2 px-4 rounded-full flex items-center transition duration-300">
          <span className="span-hover-white h-5 w-5 bg-playRed bg-no-repeat transition duration-300"></span>
          <span className="pl-1">More</span>
        </a>
      </section>
      <section className="flex flex-wrap place-content-center h-[550px] gap-14 sm:flex-row sm:h-[110%] sm:my-[32px]">
        <img src="/images/home/mikrotik.svg" alt="" className="w-[125px] lg:w-[365px] md:w-[200px] sm:w-[157px] z-10" />
        <img src="/images/home/bnsp.svg" alt="" className="w-[125px] lg:w-[325px] md:w-[200px] sm:w-[175px]" />
        <img src="/images/home/cisco.svg" alt="" className="w-[125px] lg:w-[327px] md:w-[200px] sm:w-[175px]" />
        <img src="/images/home/smk-bisa.svg" alt="" className="w-[125px] lg:w-[306px] md:w-[200px] sm:w-[175px]" />
        <img src="/images/home/adobe.svg" alt="" className="w-[125px] lg:w-[348px] md:w-[200px] sm:w-[175px]" />
        <img src="/images/home/nevtik.svg" alt="" className="w-[125px] lg:w-[315px] md:w-[200px] sm:w-[175px]" />
      </section>
    </div>
  );
};
