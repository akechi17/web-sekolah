    ...
    <section className="relative w-full bg-light-three overflow-hidden py-28" id="news">
      ...
      <div className="relative z-10  px-16 mx-auto">
        <div className="text-center mb-8">
          <h3 className="pt-9 title text-light-one before:text-light-one after:bg-light-one after:w-[450px] max-sm:after:w-[250px]">TEACHERS & STAFFS</h3>
        </div>
      </div>
      <div className="relative mt-[50px] mx-auto flex justify-center max-sm:mt-[70px] max-sm:p-4 max-md:p-4">
        <img src="images/curriculum/foto1.svg" alt="" className="block " />
      </div>
      <div className="text-center mb-8 max-sm:mt-10">
        <h3 className="mt-10 title text-black before:text-black after:bg-black after:w-[250px]">PRINCIPLE</h3>
      </div>
      <div className="relative flex max-sm:px-10 max-sm:grid max-sm:grid-cols-1 max-sm:place-items-center max-md:px-5 max-md:gap-5">
        <img className="block ml-[100px] max-sm:ml-0 max-md:ml-0 " src="images/curriculum/foto2.svg" alt="" />
        <div>
          <p className=" text-4xl mt-3 max-sm:text-xl max-md:text-lg">Nama : Kilta Aufa Qorina</p>
          <p className=" text-4xl mt-5 max-sm:text-xl max-md:text-lg">Date/Place of Birth : 6th march 2005 </p>
          <p className=" text-4xl mt-5 max-sm:text-xl max-md:text-lg">ID Number : 909090 </p>
          <div className="flex mt-[60px] max-sm:w-10 max-md:w-16">
      ...
      <div class=" justify-center ">
        <div className="w-full grid grid-cols-2 place-items-center mt-6 max-sm:grid-cols-1">
